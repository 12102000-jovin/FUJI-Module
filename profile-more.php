                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            if ($module_score !== null && $countForModule > 0) {
                                                                ...
                                                                echo "<p class='card-text' style='margin-bottom: 0;'>Highest MCQ Score: $module_score%</p>
                                                                      ...
                                                                      <a href='written-progress-more.php?module_id=$module_id' class='badge badge-pill bg-danger tooltips' data-toggle='tooltip' data-bs-placement='right' title='Check Module' style='text-decoration: none; margin-top: 10px;'>Short Answer Attempted</a>";
                                                            }
                                                            ?>
